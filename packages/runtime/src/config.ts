...
const DEFAULT_MAP_PATH = "docs/CARTODEX_MAP.md";
const DEFAULT_SCOUT_AGENT_MODEL = "gpt-5.6-luna";
const DEFAULT_SCOUT_AGENT_REASONING_EFFORT = "high";

interface CartodexConfig {
  ignore: string[];
  mapPath: string;
  scoutAgent: {
    model: string;
